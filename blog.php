        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item ">
              ...
              <li class="nav-item">
                <a class="nav-link " href="blog.php" style="color: #cfa165">Blog</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="category.php" style="color: #cfa165" >Category</a>
              </li>
              <li class="nav-item">
  ...
  while($row = $results->fetch_assoc()) {
    ...
    <table style="width :100%; table-layout:fixed ">
     <tr style="height: 200px">
      ...
      <input type="submit" name="selected" value="read more">
     </td>
