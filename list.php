        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item ">
                <a class="nav-link" href="#"  style="color: #cfa165">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link " href="blog..html" style="color: #cfa165">Blog</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="category.html" style="color: #cfa165" >Category</a>
              </li>
              <li class="nav-item">
...
<div class="card">
  ...
  <h5 class="card-header info-color white-text text-center py-4" style="background-color: #BE9DEF;"> 
